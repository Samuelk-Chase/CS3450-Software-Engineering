...
const MainPlayerView: React.FC = () => {
  ...
  const handleSubmitResponse = async () => {
    ...
    try {
      ...
      if (aiMessage.endsWith("*Receive card reward*")) {
      ...
      const mappedCard: Card = {
        ...
        type: "test", // You might need to map this properly
        ...
        // Retrieve the card data from the response
        
  
        // Update the game text with the generated card details
        ...
        // If no special pattern found, just update the game text with AI's response
